    ...
    <div className="landing-page">
      <nav className="landing-nav">
        <span className="landing-logo">
          <span className="landing-logo-mark">&lt;/&gt;</span> Buildora
        </span>
      ...
      <section className="landing-hero">
        <div className="landing-hero-content">
          ...
          <h1 className="landing-hero-title">
            ...
            <span className="landing-hero-accent">working web pages</span>
          </h1>
          <p className="landing-hero-subtitle">
            Describe what you want to build in plain English. Buildora generates
      ...
      <footer className="landing-footer">
        <div className="landing-footer-content">
          ...
          <p className="landing-footer-text">Built with Gemini</p>
        </div>
      </footer>
    </div>
  );
